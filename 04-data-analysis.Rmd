...
ranin_short_m4 <-  lmer(gen_sds_shortterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + SD100 + gen_alter  + gen_bund + gen_schule_q + gen_herkunft + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + (1 | id), data = df_stigma_long)
ranin_short_m5 <-  lmer(gen_sds_shortterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + SD100 + gen_alter  + gen_bund + gen_schule_q + gen_herkunft + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + gen_infektion_v*gen_alter_v + gen_infektion_v*gen_beruf_v + gen_infektion_v*gen_ethnie_v + (1 | id), data = df_stigma_long)
...
ranin_long_m4 <-  lmer(gen_sds_longterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + SD100 + gen_alter + gen_bund + gen_schule_q + gen_herkunft + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + (1 | id), data = df_stigma_long)
ranin_long_m5 <-  lmer(gen_sds_longterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + SD100 + gen_alter + gen_bund + gen_schule_q + gen_herkunft + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + gen_infektion_v*gen_alter_v + gen_infektion_v*gen_beruf_v + gen_infektion_v*gen_ethnie_v + (1 | id), data = df_stigma_long)
...
plot_hyp1 <- pred_h1 %>%
  ...
  ggplot(aes(x=x, y=predicted, group=SDS, col=SDS)) +
      ...
      #ggtitle( paste("Predicted Infection Status")) +
		  labs( x = "Infection Status", y = "Predicted Average Estimates for SDS") +
      theme_minimal()+
      theme(
...
lm <- lm(gen_sds_shortterm ~ SD100 + gen_bund + gen_mc_largegroups + gen_alter, data =  df_stigma_long)
summary(lm)
```
...
plot_hyp4 <- pred_long_h2 %>%
  ...
  ggplot(aes(x=x, y=predicted, group=group, colour = group)) +
      ...
      ylab("Predicted Average Estimates") + 
      scale_x_discrete(labels = c('Currently Infected','Former Infected','Not Infected')) +
      scale_color_manual(name = "Age Cohort", values=c("#999999", "#E69F00", "#56B4E9"), labels = c("22 Years", "43 Years", "64 Years")) +
      theme_minimal() +
      theme(
      axis.title = element_text(family = 'Times'),
      axis.text.x = element_markdown(family = 'Times'),
