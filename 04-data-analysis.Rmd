...
ranin_m1 <-  lmer(gen_sds_shortterm ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + (1 | vignr), data = df_stigma_long)
ranin_m2 <-  lmer(gen_sds_shortterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + (1 | vignr), data = df_stigma_long)
ranin_m3 <-  lmer(gen_sds_shortterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + gen_infektion_v*gen_alter_v + gen_infektion_v*gen_beruf_v + gen_infektion_v*gen_ethnie_v + (1 | vignr), data = df_stigma_long)

 stargazer(ranin_m1, ranin_m2, ranin_m3, 
...
ranin_m1 <-  lmer(gen_sds_longterm ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + (1 | vignr), data = df_stigma_long)
ranin_m2 <-  lmer(gen_sds_longterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + (1 | vignr), data = df_stigma_long)
ranin_m3 <-  lmer(gen_sds_longterm  ~ gen_infektion_v + gen_alter_v + gen_beruf_v + gen_sex_v + gen_ethnie_v + gen_politik + gen_situation + gen_mc_largegroups + gen_mc_smallgroups + gen_mc_bars + gen_mc_none + gen_impfung + gen_infektion_v*gen_alter_v + gen_infektion_v*gen_beruf_v + gen_infektion_v*gen_ethnie_v + (1 | vignr), data = df_stigma_long)
...
## Coef Plot - Hypothesis 1
```{r Hypothesis 1 - Coef Plot}

## Complete SDS

plot_summs(lm_hyp1_sds_short, lm_hyp1_sds_long, scale = TRUE, plot.distributions = FALSE)

## Short Term SDS

plot_summs(lm_hyp1_sds_st_short, lm_hyp1_sds_st_long, scale = TRUE, plot.distributions = FALSE)

## Long Term SDS

plot_summs(lm_hyp1_sds_lt_short, lm_hyp1_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

## Compare all full models
 
plot_summs(lm_hyp1_sds_long, lm_hyp1_sds_st_long, lm_hyp1_sds_lt_long, scale = TRUE, plot.distributions = FALSE)
...
## Coef Plot - Hypothesis 2
```{r Hypothesis 2 - Coef Plot}

## Complete SDS

plot_summs(lm_hyp2_sds_short, lm_hyp2_sds_long, scale = TRUE, plot.distributions = FALSE)

## Short Term SDS

plot_summs(lm_hyp2_sds_st_short, lm_hyp2_sds_st_long, scale = TRUE, plot.distributions = FALSE)

## Long Term SDS

plot_summs(lm_hyp2_sds_lt_short, lm_hyp2_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

## Compare all full models
 
plot_summs(lm_hyp2_sds_long, lm_hyp2_sds_st_long, lm_hyp2_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

```

## Hypothesis 3

```{r Hypothesis 3, include = FALSE}
...
## Coef Plot - Hypothesis 3 

```{r Hypothesis 3 - Coef Plot}

## Complete SDS

plot_summs(lm_hyp3_sds_short, lm_hyp3_sds_long, scale = TRUE, plot.distributions = FALSE)

## Short Term SDS

plot_summs(lm_hyp3_sds_st_short, lm_hyp3_sds_st_long, scale = TRUE, plot.distributions = FALSE)

## Long Term SDS

plot_summs(lm_hyp3_sds_lt_short, lm_hyp3_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

## Compare all full models
 
plot_summs(lm_hyp3_sds_long, lm_hyp3_sds_st_long, lm_hyp3_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

```

## Hypothesis 4

```{r Hypothesis 4, include = FALSE}
...
## Coef Plot - Hypothesis 4

```{r Hypothesis 4 - Coef Plot}

## Complete SDS

plot_summs(lm_hyp4_sds_short, lm_hyp4_sds_long, scale = TRUE, plot.distributions = FALSE)

## Short Term SDS

plot_summs(lm_hyp4_sds_st_short, lm_hyp4_sds_st_long, scale = TRUE, plot.distributions = FALSE)

## Long Term SDS

plot_summs(lm_hyp4_sds_lt_short, lm_hyp4_sds_lt_long, scale = TRUE, plot.distributions = FALSE)

## Compare all full models
 
plot_summs(lm_hyp4_sds_long, lm_hyp4_sds_st_long, lm_hyp4_sds_lt_long, scale = TRUE, plot.distributions = FALSE)
