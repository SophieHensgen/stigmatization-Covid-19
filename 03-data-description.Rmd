...
# spread data set in long format, as we are only interested in the particpant Level for the summary
...
plot_factor1 <- ggplot(loadings.sds.promax.long, aes(x=factor(id), abs(Loading), fill=Loading)) + 
  ...
  scale_x_discrete(labels = c('Neighbour', 'Marriage', 'Work', 'Food', 'Meeting', 'Child Care')) +
