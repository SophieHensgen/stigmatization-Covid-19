...
df_nolab <- df_nolab %>%
  mutate(gen_herkunft = ifelse((gen_staat == 1) & (SD700 == 2), 1, 
                               ifelse((gen_staat >= 1) & (gen_staat < 7) & (SD700 == 1), 2,
                                      ifelse((gen_staat > 1) & (gen_staat < 7) & (SD700 == 2), 2, 99))))
...
df_nolab <- df_nolab %>%
  mutate(essential_v1 = ifelse(grepl("Home Office", df_nolab$V100), 1, 0))
...
df_nolab <- df_nolab %>%
  mutate(essential_v2 = ifelse(grepl("Home Office", df_nolab$V200), 1, 0))
...
df_nolab <- df_nolab %>%
  mutate(essential_v3 = ifelse(grepl("Home Office", df_nolab$V300), 1, 0))
